...
const SportsForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error submitting sports ticket:', error);
      setSubmitStatus({
        success: false,
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g., Section 101, Row 3, Seat 12"
            />
          </div>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g., ID required at entry"
            ></textarea>
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g., No resale permitted"
            ></textarea>
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g., No refunds after purchase"
            ></textarea>
          </div>
        </div>
