...
const TheaterForm = () => {
  ...
  const validateForm = () => {
    ...
    // Basic validation
    if (!formData.performanceName) errors.performanceName = 'Performance name is required';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error submitting theater ticket:', error);
      setSubmitStatus({
        success: false,
      ...
      <form onSubmit={handleSubmit} className="ticket-form">
        <div className="form-section">
          ...
          <div className="form-group">
            <label htmlFor="performanceName">Movie Name*</label>
            <input
              type="text"
              id="performanceName"
              ...
              className={formErrors.performanceName ? 'error' : ''}
              placeholder="e.g., Hamilton, The Lion King"
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g., Broadway Theater"
            />
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g., Orchestra, Row C, Seat 12"
            />
          </div>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g., No late seating after performance begins"
            ></textarea>
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g., Valid ID must match ticket holder name"
            ></textarea>
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g., No refunds except for canceled performances"
            ></textarea>
          </div>
        </div>
